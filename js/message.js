		...
		success: function(response) {
			...
			for (let i=0; i<messages.length; i++) {
				...
				if (imgURL == null || imgURL == "") {
					...
					imgTag = "<img src='http://0fcf2098e08f.ngrok.io/tafsirmimpi/userdata/images/"+imgURL+"' width='100px' height='100px'>";
				}
				$("#messages").append("<tr>" +
					"                                        <th scope=\"row\">"+(i+1)+"</th>" +
					"                                        <td>"+imgTag+"</td>" +
...
function editMessage(index) {
	...
	$.redirect("http://0fcf2098e08f.ngrok.io/tafsirmimpi/message/edit", {
...
function deleteMessage() {
	...
	$.ajax({
		...
		cache: false,
		success: function(response) {
			window.location.href = "http://0fcf2098e08f.ngrok.io/tafsirmimpi/message";
		}
	});
}
